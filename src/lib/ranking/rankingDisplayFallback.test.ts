...
function makeVideoRow(overrides: Partial<VideoRow> = {}): VideoRow {
  return {
    ...
    is_short: false,
    is_live: false,
    video_format: "regular",
    live_state: "none",
    live_broadcast_content: "none",
    live_scheduled_start_at: null,
    live_actual_start_at: null,
    live_actual_end_at: null,
    live_metadata_fetch_status: "success",
    live_metadata_checked_at: null,
    format_signals: null,
